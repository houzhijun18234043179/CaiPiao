...
- (void)cleanDisk
{
    ...
    for (NSString *fileName in fileEnumerator)
    {
        ...
        if ([[[attrs fileModificationDate] laterDate:expirationDate] isEqualToDate:expirationDate] ||[[[attrs fileModificationDate] laterDate:expirationDate] laterDate:expirationDate])
        {
